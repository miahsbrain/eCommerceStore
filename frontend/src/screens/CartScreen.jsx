          ...
          {cartItems.map((item)=> (
            <ListGroup.Item key={item.product}>
              <Row>
                ...
                <Col md={1}>
                  <Button type='button' variant='light' onClick={() => removeFromCartHandler(item.product)}><FaTrash /></Button>
                </Col>
              </Row>
            </ListGroup.Item>
          ))}
      ...
      <Col md={4}>
        <Card>
          <ListGroup variant='flush'>
            ...
            <ListGroup.Item>
              <Button type='button' className='btn-block' disabled={cartItems.length === 0} onClick={checkoutHander}>Proceed to checkout</Button>
            </ListGroup.Item>
          </ListGroup>
        </Card>
      </Col>
